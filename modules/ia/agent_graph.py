...
def routing_agent(state: AgentState, config: RunnableConfig):
    ...
    system_prompt = SystemMessage(content=(
        ...
        "question — even briefly, e.g. 'o que vocês vendem?' - "
        "classify by the real question's intent (INSTITUTIONAL or OPERATIONAL), AVOID CHITCHAT, WHEN ASKING tudo bem? respond but also ask what you can help.\n"
