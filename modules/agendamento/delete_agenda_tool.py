...
def cancelar_agendamento(
    ...
    try:
        ...
        # COMENTÁRIO: Valida se o UPDATE realmente encontrou e alterou o agendamento no banco
                if cur.rowcount == 0:
        ...
        print(f"❌ Erro ao executar cancelar_agendamento: {ex}")
        return f"Não foi possível processar o cancelamento devido a um erro técnico. Por favor, tente novamente mais tarde."
